...
def main():
    ...
    transition_net_lstm.fit(transitions_lstm[0], transitions_lstm[1][:, -1], epochs=epochs, batch_size=batch_size)
    reward_net_lstm.fit(rewards_lstm[0], rewards_lstm[1][:, -1], epochs=epochs, batch_size=batch_size)
