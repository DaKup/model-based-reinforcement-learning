...
with window("Main Window"):
    ...
    pos = get_window_pos("Main Window")
    set_window_pos("Main Window", x=pos[0]+100, y=pos[1])
...
pos = get_window_pos("Secondary Window")
set_window_pos("Main Window", x=pos[0]+500, y=pos[1])
...
with window("Third Window"):
    pos = get_window_pos("Third Window")
    set_window_pos("Main Window", x=pos[0]+300, y=pos[1])
